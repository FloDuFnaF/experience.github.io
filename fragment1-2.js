window.addEventListener("DOMContentLoaded", () => {
  ...
  // ===== CÉSAR =====
  const cipherPhrase = "RECONSTRUCTION DE LA SEQUENCE";
  const answerPhrase = "RECONSTRUCTION DE LA SEQUENCE";
  ...
  if (cipherEl) {
    cipherEl.innerText = caesar(cipherPhrase, 3);
  }
  ...
  window.validate = function () {
    ...
    if (normalize(input) === answerPhrase) {
